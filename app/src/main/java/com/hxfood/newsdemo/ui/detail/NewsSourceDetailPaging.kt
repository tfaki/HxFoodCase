...
class NewsSourceDetailPaging(private val sources: String, private val newsRepository: NewsRepository): PagingSource<Int, News>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, News> {
        ...
        return try {
            val response = newsRepository.getNewsSourceDetail(page, sources)
            LoadResult.Page(
